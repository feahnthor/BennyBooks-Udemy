...
namespace BennyBooks.DataAccess.Migrations
{
    ...
    [Migration("20220812053302_ExtendedShoppingCart-01Db")]
    partial class ExtendedShoppingCart01Db
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BennyBooks.Models.ApplicationUser", b =>
                {
                    ...
                    b.Property<DateTime>("LastLoginAttemptedDate")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("BennyBooks.Models.ShoppingCart", b =>
                {
                    b.HasOne("BennyBooks.Models.ApplicationUser", "ApplicationUser")
                        .WithMany()
            ...
            modelBuilder.Entity("BennyBooks.Models.ApplicationUser", b =>
                {
                    b.HasOne("BennyBooks.Models.Company", "Company")
                        .WithMany()
